...
if Rails.env.development?
  ...
  if HomeBar.all.size == 0
    HomeBar.create([
                       #Ativos
                       #Completo
                       {:status_id => 1, :category_id => 1, :name => "Beco da Canela", :description => "descricao bar 1", :logo_bar_image => File.open('public/home_bars/bar1.jpg'), :phone_number => "telefone bar 1", :cellphone_number => "cel bar 1", :zip => "cep bar 1", :country_id => 1, :state_id => 1, :city_id => 1, :address => "Avenida João Naves de Ávila", :number => "123", :neighborhood => "bairro bar 1", :complement => "complemento bar 1" },
                       {:status_id => 1, :category_id => 1, :name => "Flag", :description => "descricao bar 8", :logo_bar_image => File.open('public/home_bars/bar8.jpg'), :phone_number => "9173-2592", :cellphone_number => "cel bar 8", :zip => "38408-290", :country_id => 1, :state_id => 1, :city_id => 1, :address => "Rua Barao de Camargos", :number => "193", :neighborhood => "bairro bar 8", :complement => "complemento bar 8" },
                       ...
                       {:status_id => 1, :category_id => 1, :name => "Rck'n Beer", :logo_bar_image => File.open('public/home_bars/bar2.png'), :country_id => 1, :state_id => 1, :city_id => 1, :address => "Av. Floriano Peixoto", :number => "18", :neighborhood => "bairro bar 2" },
                       {:status_id => 1, :category_id => 1, :name => "Othello Bar e Restaurante", :logo_bar_image => File.open('public/home_bars/bar5.jpg'), :country_id => 1, :state_id => 1, :city_id => 1, :address => "Avenida Segismundo Pereira", :number => "169", :neighborhood => "bairro bar 5" },

                       #0 no numero do logradouro
                       #Completo
                       {:status_id => 1, :category_id => 1, :name => "Thália", :description => "descricao bar 3", :logo_bar_image => File.open('public/home_bars/bar3.jpg'), :phone_number => "telefone bar 3", :cellphone_number => "cel bar 3", :zip => "cep bar 3", :country_id => 1, :state_id => 1, :city_id => 1, :address => "logradouro bar 3", :number => "0", :neighborhood => "bairro bar 3", :complement => "complemento bar 3"  },
                       #Somente campos obrigatórios preenchidos
                       {:status_id => 1, :category_id => 1, :name => "Mimi Quiosque", :logo_bar_image => File.open('public/home_bars/bar6.png'), :country_id => 1, :state_id => 1, :city_id => 1, :address => "Avenida João Naves de Ávila", :number => "0", :neighborhood => "bairro bar 6" },
