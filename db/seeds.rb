...
if Rails.env.development?
  ...
  if HomeBar.all.size == 0
    HomeBar.create([
                       #Ativos
                       #Completo
                       {:status_id => 1, :category_id => 1, :name => "Nome bar 1", :description => "descricao bar 1", :logo_bar_image => File.open('public/home_bars/bar1.JPG'), :phone_number => "telefone bar 1", :cellphone_number => "cel bar 1", :zip => "cep bar 1", :country_bar => "país bar 1", :state => "estado bar 1", :city => "cidade bar 1", :address => "logradouro bar 1", :number => "123", :neighborhood => "bairro bar 1", :complement => "complemento bar 1" },
                       {:status_id => 1, :category_id => 1, :name => "Nome grande bar 8", :description => "descricao bar 8", :logo_bar_image => File.open('public/home_bars/bar8.JPG'), :phone_number => "telefone bar 8", :cellphone_number => "cel bar 8", :zip => "cep bar 8", :country_bar => "país bar 8", :state => "estado bar 8", :city => "cidade bar 8", :address => "logradouro bar 8", :number => "823", :neighborhood => "bairro bar 8", :complement => "complemento bar 8" },
                       ...
                       {:status_id => 1, :category_id => 1, :name => "Nome bar 2", :logo_bar_image => File.open('public/home_bars/bar2.jpg'), :country_bar => "país bar 2", :state => "estado bar 2", :city => "cidade bar 2", :address => "logradouro bar 2", :number => "233", :neighborhood => "bairro bar 2" },
                       {:status_id => 1, :category_id => 1, :name => "Nome bar 5", :logo_bar_image => File.open('public/home_bars/bar5.jpg'), :country_bar => "país bar 5", :state => "estado bar 5", :city => "cidade bar 5", :address => "logradouro bar 5", :number => "523", :neighborhood => "bairro bar 5" },

                       #0 no numero do logradouro
                       #Completo
                       {:status_id => 1, :category_id => 1, :name => "Nome bar 3", :description => "descricao bar 3", :logo_bar_image => File.open('public/home_bars/bar3.jpg'), :phone_number => "telefone bar 3", :cellphone_number => "cel bar 3", :zip => "cep bar 3", :country_bar => "país bar 3", :state => "estado bar 3", :city => "cidade bar 3", :address => "logradouro bar 3", :number => "0", :neighborhood => "bairro bar 3", :complement => "complemento bar 3"  },
                       #Somente campos obrigatórios preenchidos
                       {:status_id => 1, :category_id => 1, :name => "Nome bar 6", :logo_bar_image => File.open('public/home_bars/bar6.jpeg'), :country_bar => "país bar 6", :state => "estado bar 6", :city => "cidade bar 6", :address => "logradouro bar 6", :number => "0", :neighborhood => "bairro bar 6" },
