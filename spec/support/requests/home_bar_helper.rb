...
def fill_in_home_bar
  ...
  fill_in "home_bar_phone_number", :with => "(034) 1234-1234"
  fill_in "home_bar_cellphone_number", :with => "(034) 9173-2592"
...
def show_home_bar_details_validator
  ...
  page.should have_content("(034) 1234-1234")
  page.should have_content("(034) 9173-2592")
